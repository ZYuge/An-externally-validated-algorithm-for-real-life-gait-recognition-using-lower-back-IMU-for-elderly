...
# General settings
repeats = 2  # repeat times of training the model
wk_label = 1
window_size = 200
overlap_rate = 0.5
...
DataX, DataY_binary, groups, filenames, subject_number = GR.load_matfiles(InputDataDir, aim_label, input_axis, del_labels)
...
plotsingal = True
model_path = f'{ModelsSaveDir}/CNNmodel_8.h5'  # the path of existing model
